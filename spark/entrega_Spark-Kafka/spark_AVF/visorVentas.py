...
#Muestro el dinero ingresado y el numero de ventas de cada tienda
consulta = spark.sql("select tienda, count(*) as ventas, cast(sum(precio) as decimal(30,2)) as beneficio from ventas group by tienda")

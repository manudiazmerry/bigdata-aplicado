...
# Hacemos la consulta
consulta=spark.sql("SELECT tienda, marca,modelo,color,energia, SUM(cantidad) as total_pedidos FROM pedidos GROUP BY tienda,marca,modelo,color,energia ORDER BY SUM(cantidad) DESC")
